...
Usage:
    ...
    python audit_inference_datapath.py --dataset DVS128_10 --config all_ln32_splitpos
"""
...
def main():
    ...
    parser.add_argument('--config', default='all_ln32_splitpos')
    ...
    print(f"\n{'=' * 90}\n {args.dataset} / {args.config} -- {seen} real batches, "
    ...
    out_csv = os.path.join(QUANT_DIR, f'datapath_audit_{args.dataset}_{args.config}.csv')
    req.to_csv(out_csv)

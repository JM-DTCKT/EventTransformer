// -----------------------------------------------------------------------------
// Q411_To_Fix : Q4.11 정수 코드 -> signed 고정소수점 Q(IW-1-IF).IF (조합)
//
...
// ## 왜 직행하나
//
// bf16 을 거치면 정규화했다가 곧바로 역정규화하는 셈이라
// 배럴 시프터 두 개가 한 사이클에 직렬로 놓입니다. 직행하면 시프터 하나로
// 끝나고, bf16 가수 8비트로 떨어뜨리던 손실도 없어집니다.
//
// ## 규약
//
// `Bf16_To_Fix` 와 맞춥니다 :
